...
public class SolarSystem implements GameControlScene {
    ...
    Planet mercury = new Planet(4, Color.gray, 57, 88);
    Planet venus = new Planet(12, new Color(150, 75, 0), 108, 224);
    Planet mars = new Planet (6, Color.red, 227, 687);
    Planet jupiter = new Planet (142, new Color(245, 245, 220), 778, 4331);
    Planet saturn = new Planet(120,new Color (245, 245, 220), 1433,10747);
    Planet uranus = new Planet (51, Color.CYAN, 2872, 30589);
    Planet neptune = new Planet (49, Color.blue, 4495, 59800);
    public SolarSystem() {
